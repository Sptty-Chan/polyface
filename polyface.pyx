...
cdef:
    long long int[22] xm = [100073378727657, 100026169713124, 100003035062944, 100082912543740, 100005931251080, 100007842199409, 100035542368320, 100074151643179, 100081304663727, 100002668834684, 100003699656193, 100060020855417, 100001529547856, 100011093077016, 100090595661987, 100005674628647, 100008249680556, 100067345147546, 100000729379224, 100001275668122, 100034157994324, 100077975485757]

    int[22] ym = [2021, 2018, 2011, 2022, 2013, 2014, 2019, 2021, 2022, 2011, 2012, 2020, 2011, 2016, 2023, 2013, 2014, 2021, 2010, 2010, 2019, 2022]

    long long int min_x = min(xm)
    long long int max_x = max(xm)
...
cpdef double minMaxScalingX(long long int x_test):
